...
class Snake(object):
    ...
    def __init__(self, L = 5, n = 30,m = 30):
        ...
        self.eaten_apple = []
        self.footnote = "Your length: " + str(L)
    ...
    def is_dead(self):
        ...
        if u or d or l or r:
        	self.footnote = "You hit the boundary!"
        suicide = self.pos[-1] in self.pos[:-1]
        if suicide:
        	self.footnote = "Ouch!! You bit yourself!"
    ...
    def run(self):
        ...
        while True:
            ...
            if len(self.eaten_apple) != 0 and self.eaten_apple[0] == self.pos[0]:
                ...
                self.pos.pop(0)
            self.footnote = "Your length: " + str(len(self.pos))
